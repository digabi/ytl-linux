...

{
  ...
  echo "    table.summary th, table.summary td { border: 1px solid #ddd; padding: 0.4rem 0.6rem; font-size: 0.9rem; white-space: nowrap; }"
  ...
  echo "    @media print {"
  echo "      table.summary th, table.summary td { white-space: normal; }"
  echo "    }"
  echo "  </style>"
  echo "</head>"
  echo "<body>"
