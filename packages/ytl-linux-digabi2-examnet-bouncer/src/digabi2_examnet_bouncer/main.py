...
def main():
    ...
    ap.add_argument("--canonical-host", type=str, required=True)  # pyright: ignore[reportUnusedCallResult]
    ap.add_argument("--ipv4-address", required=True)  # pyright: ignore[reportUnusedCallResult]
    ap.add_argument("--ncsi", action="append", type=str.lower)  # pyright: ignore[reportUnusedCallResult]
